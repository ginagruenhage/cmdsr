...
Interactive graphs can also be produced using other libraries. Here's one using the [https://github.com/tdhock/animint|animint](animint) package:
```{r animint,results="asis"}
library(animint)
library(stringr)
